...
import com.barrybecker4.optimization.strategy1.OptimizationStrategy;
...
public class Optimizer1 {
     ...
     */
    public Optimizer1(Optimizee optimizee ) {
     ...
     */
    public Optimizer1(Optimizee optimizee, String optimizationLogFile ) {
        this.optimizee = optimizee;
        logger = new Logger1(optimizationLogFile);
    }
    ...
    public void setListener(OptimizationListener1 l) {
        listener = l;
    }
}
